...
namespace Posy.Concurrency.Controllers
{
                ...
                s => s.Name, s => s.StartDate, s => s.Budget, s => s.InstructorID))
            {
                ...
                catch (DbUpdateConcurrencyException ex)
                {
                    ...
                    else
                    {
                        ...
                        ModelState.AddModelError(string.Empty, "O registro que você tentou editar foi "
                            + "modificado por outro usuário depois que você obteve o valor original. "
                            ...
                            + "Caso contrário, clique no hiperlink Voltar à lista.");
